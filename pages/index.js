    ...
    <HomeWrapper>
      ...
      <CardsWrapper>
        {filter.length > 0 ? (
              ...
              <CardImg>
                { (
                  <DynamicImage
                    ...
                    layout="fill"
                    src={`https://gateway.pinata.cloud/ipfs/QmdDjiY9NySkT7fxNf9RaxooZj76ZWxpVfdyME5ovcot5s`}
          ...
          <NoDataMessage>No campaigns found for the selected category.</NoDataMessage>
        )}
      </CardsWrapper>
    </HomeWrapper>
  );
...
export async function getStaticProps() {
  ...
  const AllData = AllCampaigns.map((e) => ({
    ...
    image: e.args.imgURI || "",
    owner: e.args.owner,
    timeStamp: e.args.timestamp ? formatDate(parseInt(e.args.timestamp) * 1000) : null,
    amount: ethers.utils.formatEther(e.args.requiredAmount),
    address: e.args.campaignAddress,
    category: typeof e.args.category === "string" ? e.args.category.toLowerCase() : "default",
  }));
